  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <header className="site-header"><div className="container header-inner">
        ...
        <div className="header-actions"><button className="icon-button" aria-label="Buscar" onClick={() => document.getElementById('search')?.focus()}><Search aria-hidden="true" /></button><a className="button button-small header-cta" href="#signup">Regístrate</a><button className="menu-button" aria-label={menuOpen ? 'Cerrar menú' : 'Abrir menú'} onClick={() => setMenuOpen(!menuOpen)}>{menuOpen ? <X /> : <Menu />}</button></div>
